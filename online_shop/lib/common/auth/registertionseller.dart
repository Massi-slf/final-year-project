...
class RegistertionSeller extends StatefulWidget {
  const RegistertionSeller({super.key});

  @override
  State<RegistertionSeller> createState() => _RegistertionSellerState();
}

class _RegistertionSellerState extends State<RegistertionSeller> {
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            reusableText(
                text: "Sign-up and wait To accept you =)",
